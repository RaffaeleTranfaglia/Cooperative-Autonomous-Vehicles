...
import pandas as pd
from plexe import ACC

def getdatetime():
        utc_now = pytz.utc.localize(datetime.datetime.utcnow())
        currentDT = utc_now.astimezone(pytz.timezone("Europe/Rome"))
...
sumoCmd = ["sumo-gui", "--duration-log.statistics", "--step-length", "0.1",
           '--tripinfo-output', 'output_file.xml', "-c", os.path.join("sim_cfg", "4way.sumocfg")]
traci.start(sumoCmd)
