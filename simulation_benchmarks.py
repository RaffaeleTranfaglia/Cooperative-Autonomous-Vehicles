...
def get_metrics(benchmark):
    ...
    # using the percentile compute the pX of the average
    # in other words, get the percentage of vehicles that are waiting less or equal than the average
    # in addition, the same thing using a neighbourhood of the average -> average +- epsilon
...
if __name__ == "__main__":
    feed1 = "sim_cfg_grid_3_lanes/tripinfo.xml"
    feed2 = "sim_cfg_grid_3_lanes/tripinfo2.xml"
    ...
    print(f"Total waiting time using platooning strategy: {platooning_metrics['total_waiting_time']}")
    print(f"Total waiting time: {normal_metrics['total_waiting_time']}")
    ...
    print(f"Average waiting time per vehicle using platooning strategy: {platooning_metrics['avg_waiting_time']}")
    print(f"Average waiting time per vehicle: {normal_metrics['avg_waiting_time']}\n")
    
    print(f"Min and Max waiting time using platooning strategy: ({platooning_metrics['min_time']},{platooning_metrics['max_time']})")
    print(f"Min and Max waiting time: ({normal_metrics['min_time']},{normal_metrics['max_time']})\n")
    ...
    print(f"Percentage of vehicle whose waiting time meets the average using platooning strategy: {platooning_metrics['percentage']}%")
    print(f"Percentage of vehicle whose waiting time meets the average: {normal_metrics['percentage']}%")